                ...
                <div class="row justify-content-end">
                    <div class="col-lg-7">
                        <div class="admission_form">
                            ...
                            <form action="admission_reg.php" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="single_input">
                                            <textarea cols="30" placeholder="Write an Application" rows="5" name="app" required></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="apply_btn">
                                            <button class="boxed-btn3" type="submit" name="apply">Apply Now</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
